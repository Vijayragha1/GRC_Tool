...
function linkedControlsSubquery() {
  return `(SELECT GROUP_CONCAT(rq_lk.ref, '; ') FROM evidence_requirement_links erl_lk
...
// crossLinksByEvidence[evId] = { iso27001:[], iso42001:[], csf:[] } (iso27001 used
// for the count badge only; iso42001/csf are actionable chips).
