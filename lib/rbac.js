...
const PERMISSIONS = {
  ...
  // Audits, MRMs, NCs, incidents, suppliers, training
...
const ROLE_PERMS = {
  ...
  consultant: [    // consultants in firm context
    ...
    'supplier.manage','training.manage','task.manage',
  ...
  contributor: [
    ...
    'document.view','document.create','document.edit','document.submit_review',
    'audit.manage','nc.manage','incident.manage','supplier.manage','training.manage',
