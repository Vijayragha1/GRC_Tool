...
const SUPPLIER_SCHEMA = {
  ...
  fields: [
    { key: 'name', label: 'Name', required: true, type: 'string',
      synonyms: ['name', 'supplier name', 'vendor name', 'vendor', 'company'] },
    { key: 'service_provided', label: 'Service provided', type: 'string',
      synonyms: ['service provided', 'service', 'description', 'product'] },
    { key: 'business_criticality', label: 'Business criticality', type: 'enum',
      values: ['low', 'medium', 'high', 'critical'],
      synonyms: ['business criticality', 'criticality', 'importance'] },
    { key: 'data_access', label: 'Data access', type: 'enum',
      values: ['none', 'public', 'internal', 'confidential', 'restricted'],
      valueSynonyms: { restricted: ['secret', 'pii', 'sensitive'] },
      synonyms: ['data access', 'data', 'data sensitivity', 'data classification'] },
    { key: 'data_volume', label: 'Data volume', type: 'enum',
      values: ['none', 'low', 'medium', 'high'],
      synonyms: ['data volume', 'volume'] },
    { key: 'dependency_type', label: 'Dependency', type: 'enum',
      values: ['multi_source', 'alternative', 'single_source'],
      valueSynonyms: { single_source: ['single', 'sole', 'sole source'], multi_source: ['multi', 'multiple'] },
      synonyms: ['dependency', 'dependency type', 'sourcing'] },
    { key: 'tier', label: 'Tier', type: 'enum',
      values: ['tier_1', 'tier_2', 'tier_3'],
      valueSynonyms: { tier_1: ['1', 'tier 1', 'critical'], tier_2: ['2', 'tier 2', 'high'], tier_3: ['3', 'tier 3', 'low'] },
      synonyms: ['tier', 'risk tier'] },
    { key: 'location', label: 'Location', type: 'string',
      synonyms: ['location', 'country', 'region', 'hq'] },
    { key: 'industry', label: 'Industry', type: 'string',
      synonyms: ['industry', 'sector'] },
    { key: 'parent_company', label: 'Parent company', type: 'string',
      synonyms: ['parent company', 'parent', 'group'] },
    { key: 'regulatory_exposure', label: 'Regulatory exposure', type: 'string',
      synonyms: ['regulatory exposure', 'regulations', 'compliance'] },
    { key: 'annual_spend', label: 'Annual spend', type: 'string',
      synonyms: ['annual spend', 'spend', 'contract value'] },
    { key: 'contract_start', label: 'Contract start', type: 'string',
      synonyms: ['contract start', 'start date', 'start'] },
    { key: 'contract_end', label: 'Contract end', type: 'string',
      synonyms: ['contract end', 'end date', 'renewal date', 'expiry'] },
    { key: 'next_review_date', label: 'Next review date', type: 'string',
      synonyms: ['next review date', 'next review', 'review date'] },
    { key: 'website', label: 'Website', type: 'string',
      synonyms: ['website', 'url', 'site'] },
    { key: 'contact_email', label: 'Contact email', type: 'string',
      synonyms: ['contact email', 'email', 'contact', 'primary contact'] }
  ],
  exampleRows: [
    {
      name: 'Acme Cloud Hosting', service_provided: 'Production infrastructure hosting',
      business_criticality: 'high', data_access: 'confidential', data_volume: 'high',
      dependency_type: 'single_source', tier: 'tier_1', location: 'Ireland',
      industry: 'Cloud infrastructure', parent_company: 'Acme Group', regulatory_exposure: 'GDPR',
      annual_spend: '120000', contract_start: '2025-01-01', contract_end: '2026-12-31',
      next_review_date: '2026-09-01', website: 'https://acme.example', contact_email: 'security@acme.example'
    },
    {
      name: 'Bright Payroll Services', service_provided: 'Outsourced payroll processing',
      business_criticality: 'medium', data_access: 'restricted', data_volume: 'medium',
      dependency_type: 'alternative', tier: 'tier_2', location: 'United Kingdom',
      industry: 'HR / Payroll', parent_company: '', regulatory_exposure: 'GDPR, PCI-DSS',
      annual_spend: '36000', contract_start: '2025-04-01', contract_end: '2026-03-31',
      next_review_date: '2026-03-01', website: 'https://brightpayroll.example', contact_email: 'dpo@brightpayroll.example'
    }
  ]
};
