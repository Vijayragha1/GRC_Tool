...
const ROLE_PERMS = {
  ...
  senior_consultant: [
    ...
    'audit.manage','mrm.manage','nc.manage','incident.manage','supplier.manage',
  ...
  // ===== Client side =====
  client_owner: [
    'workspace.update','workspace.delete','workspace.export','workspace.users.manage',
    'members.view','members.add','members.remove','members.assign_role','members.override_perms',
    ...
    'asset.view','asset.create','asset.update','asset.delete',
    'document.view','document.create','document.edit','document.submit_review',
    'document.review','document.approve','document.publish','document.retire','document.sign',
    'audit.manage','mrm.manage','nc.manage','incident.manage','supplier.manage',
    'task.manage','evidence.upload','evidence.delete',
    'comment.create','comment.delete',
    'audit_log.view','audit_log.export',
  ...
  isms_manager: [
    ...
    'asset.view','asset.create','asset.update','asset.delete',
    'document.view','document.create','document.edit','document.submit_review',
    'document.review','document.approve','document.publish','document.sign',
    'audit.manage','mrm.manage','nc.manage','incident.manage','supplier.manage',
    'task.manage','evidence.upload','evidence.delete',
    'comment.create','comment.delete',
    'audit_log.view',
  ...
  contributor: [
    // Baseline only. Row-level scoping (member_scopes) restricts what they
    // can actually view/edit; permission flags below grant capability but
    // not blanket reach. nc.manage is restricted to NCs they own elsewhere.
    'entity.view','members.view',
    'control.view','control.update',
    'risk.view','risk.update',
    'asset.view','asset.update',
    'document.view','document.create','document.edit','document.submit_review',
    'nc.manage','task.manage',
