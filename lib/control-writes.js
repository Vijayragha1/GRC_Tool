...
// Post control-state demolition (migration 019): control_states /
// iso42001_control_states are gone, so writes are UNCONDITIONALLY converged
// (control_instances is the sole source of truth). The per-workspace flag and the
// legacy fallback are retired. This stays TRUE so the cutover-4 legacy else-branches
// (which referenced the dropped tables) are confirmed-dead / unreachable.
